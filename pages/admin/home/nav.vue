<template>
    <div>
        ...
        <!-- 新增 -->
        <add-nav @change="getlist" v-if="update.show" :show.sync="update.show" :type="update.type"
            :data="update.data"></add-nav>
        <class-list v-if="addListShow" :show.sync="addListShow" :navID="currentRow._id"
            :title="currentRow.title"></class-list>
    </div>
</template>
